...
@Component({
  selector: 'app-facture.loader1',
  templateUrl: './facture.loader1.component.html',
  styleUrls: ['./facture.loader1.component.scss']
})
export class FactureLoader1Component implements OnInit {
